...
public class Quantity
{
    ...
    public static Quantity Add(Quantity q1, Quantity q2, LengthUnit? targetUnit)
    {
        ...
        if (q1.Unit == null || q2.Unit == null || targetUnit == null)
            throw new ArgumentException("Units cannot be null");

        // Convert both quantities to base unit (Feet)
        double base1 = q1.Unit.Value.ToFeet(q1.Value);
        double base2 = q2.Unit.Value.ToFeet(q2.Value);
        ...
        return new Quantity(targetUnit, resultValue);
    }
